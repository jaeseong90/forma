...
@FormaService(pgmId = "MMA010", description = "품목관리")
public class Mma010Service extends BaseService {

    private final FormaSqlSession sql;
    private final String ns = "mma010";

    public Mma010Service(FormaSqlSession sql) {
        this.sql = sql;
    }
